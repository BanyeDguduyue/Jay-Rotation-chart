...
window.onload = function ()
{
    ...
    var message_left = document.getElementById("message_left");
...
//点击小图片切换大图片
    ...
    for (var i=0; i<small_lis.length; i++)
    {
        ...
        small_lis[i].onclick = function ()
        {
            ...
            var mj = document.createTextNode(imgs[0].alt);

            message_left.replaceChild(mj,message_left.childNodes[0]);
    ...
    function tab(){
        ...
        var nubmess = document.createTextNode(shu);
        number.replaceChild(nubmess,number.childNodes[0]);
    }
...
//上一张下一张
    pre.onclick = function ()
    {
        ...
        tab();
        var mjmsee = small_lis[now].getElementsByTagName("img")[0].alt;
        var mjt = document.createTextNode(mjmsee);
        message_left.replaceChild(mjt,message_left.childNodes[0])
    };
